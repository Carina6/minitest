...
class SimpleClient(SimpleSocket):
    ...
    def connect(self, host=None, port=None):
        ...
        try:
            ...
            raise RuntimeError("Can not connect to {}:{}".format(host, port))
    ...
    def client_from_string(string):
        ...
        try:
            ...
            raise Warning("Can not defining Client host and port from {}".format(string))
...
class SimpleServer(SimpleSocket):
    ...
    def listen(self, max_connections=5, host=None, port=None):
        ...
        try:
            ...
            raise RuntimeError("Can not listen to {}:{}".format(host, port))
    ...
    def server_from_string(string):
        ...
        try:
            ...
            raise Warning("Can not defining Server host and port from {}".format(string))
